...
export class MyApp {
  ...
  constructor(platform: Platform, public toastCtrl: ToastController, public http: Http) {
    platform.ready().then(() => {
  ...
  setClassActive() {
    ...
    switch (this.currentTab) {
      case 1: { document.getElementById('tab-chat').classList.add('active'); break; }
      case 2: { document.getElementById('tab-contact').classList.add('active'); break; }
      case 3: { document.getElementById('tab-feed').classList.add('active'); break; }
      case 4: { document.getElementById('tab-other').classList.add('active'); break; }
      default: { document.getElementById('tab-chat').classList.add('active'); }
    }
  }
